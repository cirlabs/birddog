...
urlpatterns = patterns('',
    ...
    url(r'^create/(?P<requestslug>[\w-]+)/$', 'apps.doccloud.views.create', name='docs_request_create'),
    url(r'^create/$', 'apps.doccloud.views.create', name='docs_create'),
    url(r'^upload/$', 'apps.doccloud.views.upload', name='docs_upload'),
    url(r'^upload/(?P<requestslug>[\w-]+)/$', 'apps.doccloud.views.upload', name='docs_request_upload'),
)