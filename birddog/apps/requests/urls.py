...
from .views import RequestListView, RequestDetailView, new_request, RequestDetailViewPublic
...
urlpatterns = patterns('',
    ...
    url(r'detail/public/(?P<slug>.+)/$', RequestDetailViewPublic.as_view(), name="request_detail"),
)
